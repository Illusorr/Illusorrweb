  ...
  var html =
    '<footer class="sfoot">' +
      '<div class="sf-in">' +
        ...
        '</div>' +
        '<nav class="sf-col" aria-label="Site"><h2>Navigate</h2>' + links(nav) + '</nav>' +
        '<nav class="sf-col" aria-label="Sectors"><h2>Sectors</h2>' + links(sectors) + '</nav>' +
        '<nav class="sf-col" aria-label="Studio"><h2>Studio</h2>' + links(studio) +
